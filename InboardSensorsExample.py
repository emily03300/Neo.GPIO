...
while True:  # Run forever
    ...
    print("Gyroscope X: " + str(gyroVals[0]) +
          " Y: " + str(gyroVals[1]) +
          " Z: " + str(gyroVals[2]))  # turn current values (ints) to strings

    accelVals = accel.get()  # Same as gyro return xyz of current displacment force
    print("Accelerometer X: " + str(accelVals[0]) +
          " Y: " + str(accelVals[1]) +
          " Z: " + str(accelVals[2]))

    magnoVals = magno.get()  # Above
    print("Magnometer X: " + str(magnoVals[0]) +
          " Y: " + str(magnoVals[1]) +
          " Z: " + str(magnoVals[2]))
